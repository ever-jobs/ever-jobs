...
- [x] T6 — CI: shard `Test (Source Scrapers)` six ways via a matrix and `jest --shard=N/6`, `fail-fast: false`, `continue-on-error` retained, `timeout-minutes: 120`. Acceptance: shard test-counts sum exactly to the unsharded total (303+303+303+302+302+302 = 1 815).
