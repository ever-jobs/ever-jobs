...
export class JobsController {
  ...
  @ApiOperation({
    ...
    description:
      ...
      'dedup — `count` and pagination are post-exclusion, and the response carries `exclusion_metrics` ' +
      '(with `samples` when ?diagnostics is set) whenever an exclusion field was supplied.',
  })
